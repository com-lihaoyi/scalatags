...
<pre><code>// div is a function-like object, whose apply() method taking
...
<pre><code>import scalatags.XTags._
...
<pre><code>val prettier = new scala.xml.PrettyPrinter(80, 4)
println(prettier.format(frag.toXML))
