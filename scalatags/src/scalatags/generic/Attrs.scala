...
trait AttrFactory[Attr, AttrValue[_], AttrPair[_]] {
  protected[this] implicit def stringAttrX: AttrValue[String]

  def attr(s: String, ns: Namespace = null, raw: Boolean = false): Attr
  def emptyAttr(s: String, ns: Namespace = null, raw: Boolean = false): AttrPair[_]
  def AttrPair[T](attr: Attr, v: T, ev: AttrValue[T]): AttrPair[T]
}
 ...
 */
trait GlobalAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] {
...
trait SharedEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] {
  /**
 ...
 * Clipboard Events
 */
trait ClipboardEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] {
  /**
 ...
 */
trait MediaEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] with SharedEventAttrs[Attr, AttrValue, AttrPair] {
 ...
 */
trait MiscellaneousEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] with SharedEventAttrs[Attr, AttrValue, AttrPair] {
  /**
 ...
 *
 */
trait WindowEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] with SharedEventAttrs[Attr, AttrValue, AttrPair] {
  /**
 ...
 */
trait FormEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] {
  /**
 ...
 */
trait KeyboardEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] {
  /**
 ...
 */
trait MouseEventAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] {
  /**
 ...
 */
trait InputAttrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] with GlobalAttrs[Attr, AttrValue, AttrPair] {
 ...
 */
trait Attrs[Attr, AttrValue[_], AttrPair[_]] extends AttrFactory[Attr, AttrValue, AttrPair] with InputAttrs[Attr, AttrValue, AttrPair]
  with ClipboardEventAttrs[Attr, AttrValue, AttrPair]
  with MediaEventAttrs[Attr, AttrValue, AttrPair]
  with MiscellaneousEventAttrs[Attr, AttrValue, AttrPair]
  with KeyboardEventAttrs[Attr, AttrValue, AttrPair]
  with MouseEventAttrs[Attr, AttrValue, AttrPair]
  with WindowEventAttrs[Attr, AttrValue, AttrPair]
  with FormEventAttrs[Attr, AttrValue, AttrPair] {
  /**
   ...
   * MDN
   */
  lazy val defer = emptyAttr("defer")
