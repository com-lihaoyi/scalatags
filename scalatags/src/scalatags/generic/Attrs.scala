...
trait AttrsWrapper extends Core {
   ...
   */
  trait GlobalAttrs extends AttrFactory {
  ...
  trait SharedEventAttrs extends AttrFactory {
    /**
   ...
   * Clipboard Events
   */
  trait ClipboardEventAttrs extends AttrFactory {
    /**
   ...
   */
  trait MediaEventAttrs extends AttrFactory with SharedEventAttrs {
   ...
   */
  trait MiscellaneousEventAttrs extends AttrFactory with SharedEventAttrs {
    /**
   ...
   *
   */
  trait WindowEventAttrs extends AttrFactory with SharedEventAttrs {
    /**
   ...
   */
  trait FormEventAttrs extends AttrFactory {
    /**
   ...
   */
  trait KeyboardEventAttrs extends AttrFactory {
    /**
   ...
   */
  trait MouseEventAttrs extends AttrFactory {
    /**
   ...
   */
  trait InputAttrs extends AttrFactory with GlobalAttrs {
   ...
   */
  trait Attrs extends AttrFactory with InputAttrs
    with ClipboardEventAttrs
    with MediaEventAttrs
    with MiscellaneousEventAttrs
    with KeyboardEventAttrs
    with MouseEventAttrs
