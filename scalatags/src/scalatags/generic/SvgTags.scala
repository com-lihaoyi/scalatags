...
trait SvgTags[+TypedTag]{
   ...
   * MDN
   */
  val feComponentTransfer: TypedTag
  /**
   ...
   * MDN
   */
  val feDiffuseLighting: TypedTag
  /**
   ...
   * MDN
   */
  val feDisplacementMap: TypedTag
  /**
   ...
   * MDN
   */
  val feDistantLighting: TypedTag
  /**
   ...
   * MDN
   */
  val feOffset: TypedTag
  val fePointLight: TypedTag
  /**
   ...
   * MDN
   */
  val feSpecularLighting: TypedTag
  /**
   *
   */
  val feSpotlight: TypedTag
  /**
