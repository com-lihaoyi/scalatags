...
trait StylesWrapper extends Core{
  trait StyleMisc{
    protected[this] implicit def stringStyleX: StyleValue[String]
    protected[this] implicit def stringPixelStyleX: PixelStyleValue[String]
    /**
   ...
   */
  trait Styles2 extends StyleMisc{
    ...
    object columns extends Style("columns", "columns") {
      def :=(number: Int, width: String): StylePair[String] = this := s"$number $width"
    }
