 ...
 * giving you nice autocomplete and error-checking by the compiler.
 * This is a modified version for use with Scala.js. This version uses
 * strings instead of symbols, which aren't supported on Scala.js.
 * The original file is excluded from compilation when used on Scala.js.
 */
